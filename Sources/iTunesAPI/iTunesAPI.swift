...
public class iTunesSearchAPI {
    ...
    @discardableResult
    public func getResults(searchTerm: String, parameters: [String: String]?, completion: @escaping (Result<[iTunesSearchResult], iTunesSearchError>) -> Void) -> URLSessionTask {
    ...
    @discardableResult
    public func lookup(id: Int, parameters: [String: String]?, completion: @escaping (Result<[iTunesSearchResult], iTunesSearchError>) -> Void) -> URLSessionTask {
    ...
    private func parseResponse(data: Data?, response _: URLResponse?, error: Error?) -> Result<[iTunesSearchResult], iTunesSearchError> {
